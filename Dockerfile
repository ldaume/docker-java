...
RUN cd /tmp \
    && wget --header "Cookie: oraclelicense=accept-securebackup-cookie;" \
      "http://download.oracle.com/otn-pub/java/jdk/${JAVA_VERSION}u${JAVA_UPDATE}-b${JAVA_BUILD}/a58eab1ec242421181065cdc37240b08/jdk-${JAVA_VERSION}u${JAVA_UPDATE}-linux-x64.tar.gz" \
      -P /tmp \
